...
par(mar=c(3.5, 2, 1, 0))
plot(pop_mean, ylim=c(0.5,4.5), xlim=c(-10, 20), type="l", lwd=1.7, yaxt="n", ylab=" ", xlab=" ", col=rgb(0, 0, 0, 0), bty="n", xaxt="n")
abline(v=0)
segments(quantile(delta_ex[,2], c(.025)), 4, quantile(delta_ex[,2], c(0.975)), 4, lend="butt", lwd=7)
segments(quantile(delta_ex[,3], c(.025)), 3, quantile(delta_ex[,3], c(0.975)), 3, lend="butt", lwd=7)
segments(quantile(delta_ex[,4], c(.025)), 2, quantile(delta_ex[,4], c(0.975)), 2, lend="butt", lwd=7)
segments(quantile(delta_ex[,5], c(.025)), 1, quantile(delta_ex[,5], c(0.975)), 1, lend="butt", lwd=7)
points(mean(delta_ex[,2]), 4, pch=16, col="white")
points(mean(delta_ex[,3]), 3, pch=16, col="white")
points(mean(delta_ex[,4]), 2, pch=16, col="white")
points(mean(delta_ex[,5]), 1, pch=16, col="white")
text(c(-10, -10, -10, -10), c(4, 3, 2, 1), c("b", "c", "d", "e"), cex=0.8)
axis(side=1, cex.axis=0.75, at=c(-10, 0, 10, 20), mgp=c(3, 0.75, 0))
mtext(side=1, line=1.5, "Extinction delay (years)", cex=0.7)

par(mar=c(3.5, 1, 1, 1))
plot(pop_mean, ylim=c(0.5,4.5), xlim=c(-0.15, 0.3), type="l", lwd=1.7, yaxt="n", ylab=" ", xlab=" ", col=rgb(0, 0, 0, 0), bty="n", xaxt="n")
abline(v=0)
segments(quantile(delta_geo[,2], c(.025)), 4, quantile(delta_geo[,2], c(0.975)), 4, lend="butt", lwd=7)
segments(quantile(delta_geo[,3], c(.025)), 3, quantile(delta_geo[,3], c(0.975)), 3, lend="butt", lwd=7)
segments(quantile(delta_geo[,4], c(.025)), 2, quantile(delta_geo[,4], c(0.975)), 2, lend="butt", lwd=7)
segments(quantile(delta_geo[,5], c(.025)), 1, quantile(delta_geo[,5], c(0.975)), 1, lend="butt", lwd=7)
points(mean(delta_geo[,2]), 4, pch=16, col="white")
points(mean(delta_geo[,3]), 3, pch=16, col="white")
points(mean(delta_geo[,4]), 2, pch=16, col="white")
points(mean(delta_geo[,5]), 1, pch=16, col="white")
